...
mongoose.connect("mongodb+srv://@cluster0.cumy0.mongodb.net/bcasclubs?retryWrites=true&w=majority", { user: process.env.MONGOOSE_USERNAME, pass: process.env.MONGOOSE_PASSWORD, useNewUrlParser: true, useUnifiedTopology: true });
