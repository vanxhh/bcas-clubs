		...
		<main className='p-8'>
			<section className='flex gap-4 items-center mb-8'>
				...
				<div className='flex flex-col gap-2'>
					...
					<p className='mt-2'>Hosted by - from db with eventID {eventID}</p>
				</div>
			</section>
			<section className='flex gap-4'>
				<button className='text-lg p-2 border-2 border-black rounded bg-black text-white hover:bg-white hover:text-black'>Register</button>
				<button className='text-lg p-2 border-2 border-black rounded'>Join Club</button>
			</section>
		</main>
	)
}
